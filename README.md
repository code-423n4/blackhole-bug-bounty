...
Additionally, any **previously reported** vulnerabilities mentioned in [previous audit reports](https://github.com/code-423n4/blackhole-bug-bounty/blob/main/README.md#previous-audits) are not eligible for a reward.
